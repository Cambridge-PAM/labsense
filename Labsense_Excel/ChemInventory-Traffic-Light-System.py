...
from gsk_enviro_dict_temp import (
    gsk_composite_red,
...
sum_composite_green = sum(
    composite_green_list
)  # summing all the volumes for each colour
...
new_rows = [
    {"Date": datetime.datetime.now(), "Volume (L)": sum_composite_red, "Colour": "RED"},
    {
        ...
        "Volume (L)": sum_composite_yellow,
        "Colour": "YELLOW",
    },
    {
        "Date": datetime.datetime.now(),
        "Volume (L)": sum_composite_green,
        "Colour": "GREEN",
    },
]
...
new_rows = [
    ...
    {
        "Date": datetime.datetime.now(),
        "Volume (L)": sum_health_yellow,
        "Colour": "YELLOW",
    },
    {
        "Date": datetime.datetime.now(),
        "Volume (L)": sum_health_green,
        "Colour": "GREEN",
    },
]
