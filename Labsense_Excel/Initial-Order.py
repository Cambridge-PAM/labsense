...
def main():
   ...
   df = pd.read_excel("read-file-name.xlsx",engine='openpyxl')#add the file you want to read from
   ...
   for key, value in gsk_2016.items():
       ...
       if ord_chem_cas.empty:
           ...
           new_df.loc[next_index] = [value,key, temp_sum, today]#adding new row to dataframe
