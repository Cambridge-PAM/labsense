...
for key, value in hazard_groups.items():
	...
	if ghs_df.empty:
		...
		ghs_df_quant = ghs_df.iloc[:, [1, 2, 3, 4, 5, 6, 7]] #restrict columns to 'name', 'location', 'size', 'unitid', 'unit', 'substance', and 'cas'
		ghs_df_real = ghs_df_quant.loc[ghs_df_quant["location"]!=527895] #remove any entries in "Missing - Stockcheck Only" location
